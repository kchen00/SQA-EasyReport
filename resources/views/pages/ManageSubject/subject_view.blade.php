...
@section('content')
    ...
    <div class="container-fluid py-4">
        <div class="card p-4">
            <div class="row">
                <div>
                    <form action="{{ route("subject.update.store", ["subject_id"=>$subject->id]) }}" method="POST" id="subject_form">
                        <fieldset>
                            @csrf
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name"
                                            placeholder="subject name" value="{{ $subject->name }}" onchange="enable_form_submit()">
                                        @error('name')
                            ...
                            <div class="row row-col-2">
                                <div class="col text-end">
                                    <a role="button" class="btn btn-danger rounded-pill" data-bs-toggle="modal"
                                            ...
                                            onclick="confirm_delete('{{ $subject->name }}', '{{ $subject->id }}')">Delete Subject</a>
                                </div>
